  ...
  return (
    <>
      <div className=" w-full max-w-screen-2xl min-h-dvh dark:bg-black mx-auto">
        <Header />
        <div className="innerbody mx-auto max-w-5xl min-w-64">
          <section className="px-4 ">
            ...
            <div className=" relative m-10 xs:m-0 xs:my-4	text-6xl	xs:text-4xl">
              ...
              <p className="font-Gist text-textSecondary text-2xl	mt-20	xs:text-lg	">
                I'm a{" "}
              ...
              <p className="mt-4 font-Gist text-textSecondary text-2xl	mt-20	xs:text-base">
                I've explored{" "}
                <span className="text-textPrimary underlinetext">
                  C, C++, Java, and Python
                </span>
